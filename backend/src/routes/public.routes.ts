...
import { getStripeDiagnostic } from '../controllers/subscription.controller';
...
router.get('/diag-stripe', getStripeDiagnostic);
router.get('/config', (req, res) => {
  res.json({
    ...
    isPlansEnabled: process.env.ENABLE_PLANS !== 'false'
  });
});
